...
export function SourceIcon({ name, size = 22, ...props }: SourceIconProps) {
  ...
  if (name === "camera") {
    return (
      <svg {...common}>
        <path
          d="M8.2 7.2 9.4 5.4h5.2l1.2 1.8H18.5A1.5 1.5 0 0 1 20 8.9v8.2A1.5 1.5 0 0 1 18.5 18.6h-13A1.5 1.5 0 0 1 4 17.1V8.9A1.5 1.5 0 0 1 5.5 7.2h2.7Z"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinejoin="round"
        />
        <circle cx="12" cy="12.6" r="3.1" stroke="currentColor" strokeWidth="1.6" />
      </svg>
    );
  }
  if (name === "chat") {
    return (
      <svg {...common}>
        <path
          d="M6 7.2h12A2.3 2.3 0 0 1 20.3 9.5v6.2A2.3 2.3 0 0 1 18 18H11l-4.2 2.6V18H6A2.3 2.3 0 0 1 3.7 15.7V9.5A2.3 2.3 0 0 1 6 7.2Z"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinejoin="round"
        />
        <path
          d="M8 11.2h8M8 14.2h5"
          stroke="currentColor"
          strokeWidth="1.6"
          strokeLinecap="round"
        />
