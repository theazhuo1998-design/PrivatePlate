  ...
  licenses: [
    {
      ...
      name: "PrivatePlate synthetic fixture review notice",
      path: "fixtures/LICENSES/PRIVATEPLATE_SYNTHETIC_DEMO_1.0.txt",
      allowsPublicRedistribution: false,
      notes: "Provenance and final data-license approval are pending."
    }
  ],
  sources: [
    {
      id: "src-synthetic-demo",
      author: "PrivatePlate project",
      description: "Synthetic household, foods, templates, and knowledge cards for the runnable demo.",
      modified: false,
      allowsPublicRedistribution: false
    }
  ],
